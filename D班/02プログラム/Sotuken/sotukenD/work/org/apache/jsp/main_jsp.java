...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ArrayList<MainFormBeans> userMail = (ArrayList)session.getAttribute("USER_MAIL"); 
      ...
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<button type=\"button\" onclick=\"location.href='/sotukenD/MailSServlet'\">新規メール</button>\r\n");
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<h2>受信メール</h2>\r\n");
      out.write("\t\t\t<table id=\"mail\" cellspacing=\"0\" frame=\"box\" border=\"1\">\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th width=\"5%\"><input type=\"checkbox\"></th>\r\n");
      out.write("\t\t\t\t\t<th width=\"20%\">送信者</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"10%\"></th>\r\n");
      out.write("\t\t\t\t\t<th width=\"65%\">タイトル</th>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t");
for (int i = 0; i < userMail.size(); i++) {
      ...
      out.write("\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<input type=\"submit\" value=\"選択を削除\">\r\n");
