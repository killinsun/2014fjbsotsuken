		...
		<div id="contents">
			<div id="main">
				...
				<table border="1" cellspacing="0">
					<tr>
						<td width="100"><font size="4">氏名</font></td>
						<td><font size="4"><%=loginUser.getSei()%><%=loginUser.getMei()%></font></td>
					</tr>
						<td><font size="4">性別</font></td>
						<td><font size="4"><%=loginUser.getSeibetu()%></font></td>
					</tr>
					<tr>
						<td><font size="4">生年月日</font></td>
						<td><font size="4"><%=loginUser.getSeinengappi()%></font></td>
					</tr>
					<tr>
						<td><font size="4">電話番号</font></td>
						<td><font size="4"><%=loginUser.getTel()%></font></td>
					</tr>
					<tr>
						<td><font size="4">ﾒｰﾙｱﾄﾞﾚｽ</font>
						</td>
						<td><font size="4"><%=loginUser.getMail()%></font>
						</td>
					</tr>
					<tr>
						<td><font size="4">郵便番号</font></td>
						<td><font size="4"><%=loginUser.getYubin()%></font></td>
					</tr>
					<tr>
						<td><font size="4">住所</font></td>
						<td><font size="4"><%=loginUser.getTodouhuken()%><%=loginUser.getAddress()%><%=loginUser.getAddress2()%></font></td>
					</tr>
				</table>
				</p>
				<p></p>
			...
			<div id="sub">
				<div class="section">
					...
					<ul>
						<font size="3px">
							<li><a href="MypageServlet"><font color="blue">登録情報確認</font></a>
						</li> <br>
