...
import jp.ac.fjb.eLearning.bean.Reading_AinputBean;
import jp.ac.fjb.eLearning.bean.Reading_QinputBean;
import jp.ac.fjb.eLearning.util.DBManager;

public class Reading_AModel {

	// ***************************************** //
	//  IDとパスワードを元に、ユーザ情報を取得する
	// ***************************************** //
	public Reading_AinputBean getKaisetu(String kyouka,String kamoku, String bunya) {

		// ユーザ情報格納用
		Reading_AinputBean user = new Reading_AinputBean();
		...
		try {
			...
			user.setKaisetu(rs.getString("解説文"));
