...
public final class _014ContentDisplay_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	//UserMailBean umb = (UserMailBean)session.getAttribute("MAIL_USER");
      ...
      out.write("\t\t<link rel=\"stylesheet\" href=\"stylesheet/014ContentDisplay.css\" type=\"text/css\"/>\r\n");
      out.write("\t\t<script src=\"js/jquery.min.js\"></script>\r\n");
      out.write("\t\t<!--<script src=\"js/javascript.js\"></script>-->\r\n");
      out.write("\r\n");
      out.write("\t\t<title>014内容表示画面</title>\r\n");
      out.write("\t</head>\r\n");
      out.write("\r\n");
      out.write("<body>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<button id=\"button1\" class=\"frame button\" type=\"button\" value=\"aaa\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\tメッセージ作成\r\n");
      out.write("\t\t\t\t\t\t\t\t</button></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"box\"> 受信箱 (100) </td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"box\"> 下書き (件数) </td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"box\"> 送信箱 (件数) </td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"box\"> ゴミ箱 (件数) </td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" size=\"100\" maxlength=\"100\" value=\"");
      out.print(umb.getUserAddress() );
      out.write("\" disabled />\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea size=\"100\" maxlength=\"500\" disabled>");
      out.print(umb.getMainLine() );
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
