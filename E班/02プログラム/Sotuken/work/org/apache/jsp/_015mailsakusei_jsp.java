...
public final class _015mailsakusei_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	LoginBean lb = (LoginBean) session.getAttribute("LOGIN_USER");
      ...
      out.write("\t\t<link rel=\"stylesheet\" href=\"stylesheet/015mailsakusei.css\" type=\"text/css\"/>\r\n");
      out.write("\t\t<script src=\"js/jquery.min.js\"></script>\r\n");
      out.write("\t\t<!--<script src=\"js/javascript.js\"></script>-->\r\n");
      out.write("\t\t<script src=\"js/mail.js\"></script>\r\n");
      out.write("\r\n");
      out.write("\t\t<title>015文章作成画面</title>\r\n");
      out.write("\t</head>\r\n");
      out.write("\r\n");
      out.write("<body>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<button id=\"button1\" class=\"frame button\" type=\"reset\" value=\"aaa\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\tメッセージ作成\r\n");
      out.write("\t\t\t\t\t\t\t\t</button></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td id=\"delete\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button id=\"button2\" class=\"frame button\" type=\"button\" value=\"aaa\" onclick=\"statusDisplay()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t送信\r\n");
      out.write("\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button id=\"button3\" class=\"frame button\" type=\"button\" value=\"aaa\"  onclick=\"mailDraft()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t下書き保存\r\n");
      out.write("\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><b>宛先</b></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" size=\"100\" maxlength=\"100\" name=\"sendAddress\" value=\"\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><b>件名</b></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" size=\"100\" maxlength=\"100\" name=\"subjectLine\" value=\"\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><b>本文</b></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea size=\"100\" maxlength=\"500\" placeholder=\"本文を入力してください\" name=\"mailLine\" ></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!--<textarea size=\"100\" maxlength=\"500\" placeholder=\"本文を入力してください\" name=\"mailLine\" >");
      out.write("</textarea>-->\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td> 　</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<td align=\"left\"><b>添付ファイル：</b>\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"mt\" id=\"mt\">\r\n");
      out.write("</form>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
    } catch (Throwable t) {
