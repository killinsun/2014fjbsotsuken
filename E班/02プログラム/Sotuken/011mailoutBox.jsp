...
<html>
	<head>
		...
		<link rel="stylesheet" href="stylesheet/011mailoutBox.css" type="text/css"/>
		<script src="js/jquery.min.js"></script>
		<!--<script src="js/javascript.js"></script>-->
		<script src="js/mail.js"></script>
		<title>011送信一覧画面</title>
	</head>
					...
					<div id="table">
						...
						<table id="mailbutton">
							<tr id="action">
								...
								<td id="delete">
								<button id="deletemoveButton"  name="deletemoveButton" type="button" value="02" onclick="deletemoveClick2()">
									削除
								</button></td>
							</tr>
						</table>
						...
						<table id="mailtable1">
							...
							<tr onclick="mailoutBox()">
								<td class="box" id="boxcolor"> 送信箱 </td>
							</tr>
