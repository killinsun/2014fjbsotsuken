...
<link rel="stylesheet" href="stylesheet/template/nav.css"
	type="text/css" />
<link rel="stylesheet" href="stylesheet/010mail.css" type="text/css" />
<script src="js/jquery.min.js"></script>
<!--<script src="js/javascript.js"></script>-->
<script src="js/mail.js"></script>

<title>010受信一覧画面</title>
</head>
			...
			<div id="contents">
				...
				<div id="table">
					...
					<table id="mailbutton">
						<tr id="action">
							<td id="operation">
								<button id="button1" class="frame button" type="button"
									value="aaa" onclick="mailsakusei()">メッセージ作成</button></td>
							<td id="delete">
								<button id="deletemoveButton"  name="deletemoveButton" class="frame button" type="button"
									value="01" onclick="deletemoveClick()">削除</button></td>
						</tr>
					</table>
					...
					<table id="mailtable1">
						<tr onclick="mail()">
							<td class="box" id="backcolor">受信箱</td>
						</tr>
					...
					<table id="mailtable2">
						<!-- 差出人、件名、送信日時 -->
						<tr id="itemName">
							<td class="checkbox partition"><input class="check"
								type="checkbox" value="1">
							</td>
							<td class="clip partition"><img class="clipImg"
						...
						<tr class="line">
							...
							<td onclick="mailkakunin('<%=UserMail.getMailId()%>')"><%=UserMail.getUserName()%></td>
							<td onclick="mailkakunin('<%=UserMail.getMailId()%>')"><%=UserMail.getSubjectLine()%></td>
							<td onclick="mailkakunin('<%=UserMail.getMailId()%>')"><%=UserMail.getReceiptTime()%></td>
						</tr>
						<%
							}
						%>
