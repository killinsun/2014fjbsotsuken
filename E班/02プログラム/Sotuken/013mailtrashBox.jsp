...
<html>
	<head>
		...
		<link rel="stylesheet" href="stylesheet/013mailtrashBox.css" type="text/css"/>
		<script src="js/jquery.min.js"></script>
		<!--<script src="js/javascript.js"></script>-->
		<script src="js/mail.js"></script>
		<title>013ゴミ箱画面</title>
	</head>
					...
					<div id="table">
						...
						<table id="mailbutton">
							<tr id="action">
								...
								<td id="delete">
								<button id="deleteButton"  name="deleteButton" class="frame button" type="button"
									value="04" onclick="deleteClick()">
									削除
								</button></td>
							</tr>
						</table>
						...
						<table id="mailtable1">
							...
							<tr onclick="mailtrashBox()">
								<td class="box" id="boxcolor"> ゴミ箱 </td>
							</tr>
							<tr>
								<td class="space"></td>
							</tr>
						...
						<table id="mailtable2">
							...
							<tr id="itemName">
								...
								<input class="check" type="checkbox" value="4">
								</td>
