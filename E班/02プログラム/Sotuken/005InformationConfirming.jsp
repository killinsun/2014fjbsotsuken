...
<html>
	<head>
		...
		<link rel="stylesheet" href="stylesheet/005InformationConfirming.css" type="text/css"/>
		<script>
			function jump() {
				location.href = "003sendEmailCompletion.jsp";
			}
		</script>
		<title>005情報確認画面</title>
	</head>
	...
	<div id="nav">
		<div id="innerNav">
			...
			<!-- ***************************************************************************** -->
			<!-- ***************************************************************************** -->
			<a href="005InformationConfirming.jsp">
				<div id="newFeed">
					...
					<div id="userInfo">
						...
						<div id="right">
							<div id="user">
								<table>
									<tr>
										<td class="name">氏名</td><td>名称不明</td>
									</tr>
									<tr>
										<td class="name">フリガナ</td><td>名称不明</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="name">ID</td><td>不明</td>
									</tr>
									<tr>
										<td class="name">PASSWORD</td><td>不明</td>
									</tr>
									<tr>
										<td class="name">メールアドレス</td><td>●●●●●●●●</td>
									</tr>
									<tr>
										<td class="name">郵便番号</td><td>不明</td>
									</tr>
									<tr>
										<td class="name">出身地</td><td>千葉県八街市●●●●</td>
									</tr>
									<tr>
										<td class="name">部署</td><td>総務部</td>
									</tr>
									<tr>
										<td class="name">自己紹介</td><td>
										<p>
								...
								<input type="button"　id="enter" value="変更する" />
							</div>
						</div>
					</div>
				</div>
